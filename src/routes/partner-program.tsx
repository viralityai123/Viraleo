...
export const Route = createFileRoute("/partner-program")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Join the Viraleo Partner Program. Earn 50% recurring commission on every referral. Promote the best YouTube channel intelligence tool." },
      { property: "og:title", content: "Viraleo Partner Program — Earn 50% Commission" },
      { property: "og:description", content: "Earn 50% recurring commission. Join the Viraleo partner program." },
    ...
    <div className="calc-wrap" id="calculator">
      <div className="calc-slider-row">
        <div className="calc-slider-label">
          ...
          <span className="calc-slider-val">{aud >= 1000 ? `${(aud / 1000).toFixed(0)}k viewers` : `${aud} viewers`}</span>
        </div>
        <input
          className="calc-slider"
          type="range" min={1000} max={500000} step={1000} value={aud}
      ...
      <div className="calc-slider-row">
        ...
        <input
          className="calc-slider"
          type="range" min={1} max={10} step={1} value={cvr}
      ...
      <div className="calc-slider-row" style={{ marginBottom: 0 }}>
        ...
        <input
          className="calc-slider"
          type="range" min={0} max={100} step={5} value={mix}
      ...
      <div className="calc-results">
        <div className="calc-res-card">
          ...
          <div className="calc-res-val green" id="r-monthly">{fmtUSD(monthly)}</div>
        </div>
        <div className="calc-res-card">
          <div className="calc-res-label">Yearly</div>
          <div className="calc-res-val green" id="r-yearly">{fmtUSD(monthly * 12)}</div>
        </div>
        <div className="calc-res-card">
          <div className="calc-res-label">Per referral</div>
          <div className="calc-res-val green" id="r-per">{fmtUSD2(perRef)}</div>
        </div>
      </div>
    </div>
  );
...
function PartnerProgramPage() {
  ...
  return (
    <>
      ...
      <div className="pp">
        <nav className="nav">
          <div className="nav-logo"><span>Viraleo</span> Partners</div>
          <div className="nav-pill" onClick={goLogin}>Apply now →</div>
        </nav>

        <div className="hero">
          <div className="hero-eyebrow">Invite-only · For top creators only</div>
          <h1 className="hero-h1">
            Share <em>smarter.</em><br />
            <span className="rainbow-wrap">
              Earn bigger.
              <svg className="rainbow-svg" viewBox="0 0 320 18" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 12 C 30 4, 60 16, 90 10 C 120 4, 150 14, 180 9 C 210 4, 240 15, 270 9 C 290 5, 308 13, 316 10" fill="none" stroke="url(#rg)" strokeWidth="3.5" strokeLinecap="round" />
                <defs><linearGradient id="rg" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#f97316" /><stop offset="25%" stopColor="#ec4899" /><stop offset="50%" stopColor="#8b5cf6" /><stop offset="75%" stopColor="#3b82f6" /><stop offset="100%" stopColor="#10b981" /></linearGradient></defs>
              </svg>
            </span>
          </h1>
          <p className="hero-sub">We give our most trusted creators <strong>50% of every sale</strong> they drive. No caps, no tricks — just the best affiliate deal in the creator economy.</p>
          <div className="hero-ctas">
            <button className="cta-primary" onClick={goLogin}>Apply for access →</button>
            <button className="cta-sec" onClick={scrollToCalculator}>See earnings calculator</button>
          </div>
        </div>

        <div className="badge-strip">
          <div className="badge"><span className="badge-dot" />50% commission — industry best</div>
          <div className="badge"><span className="badge-dot" />Real-time earnings dashboard</div>
          <div className="badge"><span className="badge-dot" />Payouts every 30 days</div>
          <div className="badge"><span className="badge-dot" />Dedicated partner manager</div>
        </div>

        <div className="commission-blk">
          <div className="commission-num">50%</div>
          <div className="commission-label">Of every sale. Forever.</div>
          <div className="commission-sub">Most platforms offer 20–30%. We give you half. Because your audience built this.</div>
        </div>

        <div className="section">
          <div className="eyebrow">What you get</div>
          <div className="section-h">Every perk, no compromises.</div>
          <div className="section-sub">Built for creators who take content seriously. This isn't a basic referral link — it's a full business partnership.</div>
          <div className="perks-grid">
            <div className="perk-card">
              <div className="perk-icon">%</div>
              <div className="perk-title">50% revenue share</div>
              <div className="perk-body">Every plan — Pro, Team, Enterprise. You refer it, you earn half. No tiers, no fine print.</div>
            </div>
            <div className="perk-card">
              <div className="perk-icon">↗</div>
              <div className="perk-title">Live earnings dashboard</div>
              <div className="perk-body">Watch every click, trial, and conversion in real time. Your own partner portal, always on.</div>
            </div>
            <div className="perk-card">
              <div className="perk-icon">✦</div>
              <div className="perk-title">Exclusive partner badge</div>
              <div className="perk-body">Verified Viraleo Partner status on your profile. Signals trust to your audience instantly.</div>
            </div>
            <div className="perk-card">
              <div className="perk-icon">⚡</div>
              <div className="perk-title">Priority support</div>
              <div className="perk-body">Direct Slack access to our team. Questions answered in hours, not days. VIP treatment.</div>
            </div>
            <div className="perk-card">
              <div className="perk-icon">◈</div>
              <div className="perk-title">Early feature access</div>
              <div className="perk-body">You test new tools before anyone else. Be the first to cover what's coming — before the internet does.</div>
            </div>
          </div>
        </div>
        ...
        <div className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-sub">Apply once, get approved, and start earning. The whole setup takes under 10 minutes.</div>
          <div className="hiw-steps">
            <div className="hiw-connector" />
            <div className="hiw-step">
              <div className="hiw-num">1</div>
              <div className="hiw-step-title">Apply</div>
              <div className="hiw-step-body">Fill out a short form. We review your channel and audience fit within 48 hours.</div>
            </div>
            <div className="hiw-step">
              <div className="hiw-num">2</div>
              <div className="hiw-step-title">Get your link</div>
              <div className="hiw-step-body">Instantly get your unique partner link and custom discount code for your audience.</div>
            </div>
            <div className="hiw-step">
              <div className="hiw-num">3</div>
              <div className="hiw-step-title">Earn 50%</div>
              <div className="hiw-step-body">Share naturally. Earn half of every sale. Monthly payouts, zero minimums.</div>
            </div>
          </div>
        </div>
        ...
        <div className="section" style={{ paddingTop: 0 }}>
          ...
          <div className="section-h">
            <span className="rainbow-wrap">
              Your number.
              <svg className="rainbow-svg" viewBox="0 0 260 18" preserveAspectRatio="none" xmlns="http://www.w3.org/2000/svg">
                <path d="M4 12 C 25 4, 55 15, 85 9 C 115 3, 145 15, 175 9 C 200 4, 225 14, 254 10" fill="none" stroke="url(#rg2)" strokeWidth="3.5" strokeLinecap="round" />
                <defs><linearGradient id="rg2" x1="0%" y1="0%" x2="100%" y2="0%"><stop offset="0%" stopColor="#f97316" /><stop offset="33%" stopColor="#8b5cf6" /><stop offset="66%" stopColor="#3b82f6" /><stop offset="100%" stopColor="#10b981" /></linearGradient></defs>
              </svg>
            </span>
            &nbsp;Slide to see it.
          </div>
          <div className="section-sub">Drag the sliders to model your potential monthly earnings as a Viraleo Partner.</div>
          <Calculator />
        </div>
        ...
        <div className="section" style={{ paddingTop: 0, paddingBottom: 80 }}>
          <div className="cta-bottom">
            ...
            <div className="cta-bottom-h">Your audience is an<br /><em>asset. Start treating it that way.</em></div>
            <div className="cta-bottom-sub">Applications reviewed within 48 hours. Spots are limited — we keep this program small and exclusive by design.</div>
            <button className="cta-bottom-btn" onClick={goLogin}>Apply for partner access →</button>
            <div className="cta-bottom-note">Invite-only · Premium creators only · 50% commission</div>
          </div>
        </div>
      </div>
    </>
