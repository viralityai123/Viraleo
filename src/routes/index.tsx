...
export const Route = createFileRoute("/")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Decode viral YouTube channels. Hooks, retention, thumbnails, niche fit — AI-powered channel analysis for creators." },
      { property: "og:title", content: "Viraleo — YouTube Channel Intelligence, decoded" },
      { property: "og:description", content: "Decode viral YouTube channels. Hooks, retention, thumbnails, niche fit." },
