...
export const Route = createFileRoute("/blog")({
  head: () => ({
    meta: [
      ...
      { name: "description", content: "Learn how to grow your YouTube channel with data-driven insights. Thumbnail optimization, niche research, shadowban detection, and more from the Viraleo team." },
      { property: "og:title", content: "Blog — Viraleo | YouTube Growth & Channel Intelligence" },
      { property: "og:description", content: "Learn how to grow your YouTube channel with data-driven insights." },
...
const ARTICLES = [
  {
    ...
    excerpt: "Your thumbnail determines 80% of whether a viewer clicks. We analyze data from 10,000+ viral videos to show you exactly what makes a winning thumbnail — and how to design one in minutes.",
    date: "June 1, 2026",
    readTime: "6 min",
  ...
  },
  {
    ...
    excerpt: "Most creators pick niches by gut feel and burn out. We break down how to use RPM data, competition analysis, and outlier detection to find a niche where you can actually grow.",
    date: "May 28, 2026",
    readTime: "8 min",
  ...
  return (
    <main className="min-h-screen bg-surface">
      <div className="max-w-3xl mx-auto px-6 py-24">
        <div className="mb-16">
          <div className="text-emerald-600 text-sm font-bold tracking-widest uppercase mb-3">Blog</div>
          <h1 className="text-4xl md:text-5xl font-black text-ink tracking-tight">
            YouTube growth,<br />decoded.
          </h1>
          <p className="mt-4 text-ink-soft text-lg max-w-xl">
            Data-driven guides, case studies, and strategies to help you grow your channel with confidence instead of guesswork.
          </p>
        </div>
                ...
                <div>
                  ...
                  <div className="flex items-center gap-2 mt-4">
                    {article.tags.map((tag) => (
                      <span key={tag} className="text-[11px] font-semibold px-2.5 py-1 rounded-full bg-emerald-50 text-emerald-700">
                        {tag}
                      </span>
                    ))}
                  </div>
                </div>
                <ArrowRight size={20} className="text-ink-soft group-hover:text-emerald-500 shrink-0 mt-1 transition-colors" />
              </div>
            </Link>
          ))}
        </div>
