  ...
  head: () => ({
    meta: [
      { title: "Sign In — Viraleo" },
      {
        name: "description",
        content:
          "Sign in to Viraleo with Google. Access AI-powered YouTube thumbnail testing, niche ranking, and channel analysis tools.",
      },
      { property: "og:title", content: "Sign In — Viraleo" },
      {
        property: "og:description",
        content: "Sign in to Viraleo and unlock AI-powered YouTube channel intelligence.",
      },
  ...
  return (
    <div className="relative min-h-screen flex flex-col items-center justify-center bg-[#f5f5f7] px-5 py-10 overflow-hidden">
      ...
      <div className="relative z-10 w-full max-w-sm mx-auto flex flex-col items-center">
        ...
        >
          <h1
            className="text-[clamp(26px,4vw,36px)] font-bold leading-[1.08] tracking-tight text-[#1d1d1f]"
            style={{ letterSpacing: "-1.2px" }}
          >
            {fromPartner ? (
              <>
                Print money
                <span className="bg-gradient-to-br from-[#30d158] to-[#25a244] bg-clip-text text-transparent">
                  .
                </span>
              </>
            ) : (
              <>
                Your channel&apos;s viral potential
                <span className="bg-gradient-to-br from-[#30d158] to-[#25a244] bg-clip-text text-transparent">
                  .
                </span>
              </>
          ...
          <p
            className="mt-2 text-[15px] text-[#6e6e73] font-normal"
            style={{ letterSpacing: "-0.1px" }}
          >
            {fromPartner
              ? "Earn 50% commission on every referral. Partner program."
              : "The AI engine behind the videos you wish you made."}
          </p>
        </div>

        <div
          className="w-full rounded-[24px] border border-white/70 px-8 py-8 pb-7"
          style={{
            background: "rgba(255,255,255,0.82)",
            backdropFilter: "blur(28px) saturate(1.8)",
            WebkitBackdropFilter: "blur(28px) saturate(1.8)",
            boxShadow:
              "0 2px 0 rgba(255,255,255,0.9) inset, 0 8px 40px rgba(0,0,0,0.10), 0 2px 8px rgba(0,0,0,0.06)",
        ...
        >
          <div className="flex bg-black/10 rounded-[10px] p-[3px] mb-[26px]">
            <button
              ...
              style={{
                ...
                boxShadow:
                  tab === "signin"
                    ? "0 1px 4px rgba(0,0,0,0.1), 0 0.5px 1px rgba(0,0,0,0.06)"
                    : "none",
                fontFamily: "inherit",
                border: "none",
              }}
          ...
          <div className="flex items-center gap-[10px] mb-[18px]">
            ...
            <span className="text-[12px] text-[#6e6e73]" style={{ letterSpacing: "0.1px" }}>
              or
            </span>
            <div className="flex-1 h-px bg-black/10" />
          </div>
        ...
        <p
          className="mt-[18px] text-[13px] text-[#6e6e73] text-center"
        ...
        >
          {tab === "signin" ? (
            <>
              ...
              <button
                onClick={() => setTab("signup")}
                className="text-[#0071e3] font-medium bg-transparent border-none cursor-pointer text-[13px] hover:underline"
...
function SigninContent({ loading, onGoogle }: { loading: boolean; onGoogle: () => void }) {
  return (
    <>
      <div className="mb-3">
        <label className="block text-[12px] font-semibold text-[#6e6e73] uppercase tracking-wider mb-[5px]">
          Email
        </label>
        <input
          type="email"
          ...
          onFocus={(e) => {
            e.target.style.borderColor = "#30d158";
            e.target.style.background = "#fff";
            e.target.style.boxShadow = "0 0 0 3px rgba(48,209,88,0.15)";
          }}
          onBlur={(e) => {
      ...
      <p
        className="mt-[14px] text-[11.5px] text-[#6e6e73] text-center leading-[1.6]"
        style={{ letterSpacing: "-0.1px" }}
      >
        By signing in you agree to our{" "}
        <a href="/terms" className="text-[#0071e3] no-underline hover:underline">
          Terms
        </a>{" "}
        &amp;{" "}
        <a href="/privacy-policy" className="text-[#0071e3] no-underline hover:underline">
          Privacy Policy
        </a>
        .
      </p>
  ...
  return (
    <button
      ...
      style={{
        ...
        boxShadow:
          "0 1px 0 rgba(255,255,255,0.25) inset, 0 4px 16px rgba(48,209,88,0.4), 0 1px 3px rgba(0,0,0,0.15)",
      }}
      onMouseEnter={(e) => {
        e.currentTarget.style.background = "linear-gradient(180deg, #45e074 0%, #28b34a 100%)";
        e.currentTarget.style.transform = "translateY(-1px)";
        e.currentTarget.style.boxShadow =
          "0 1px 0 rgba(255,255,255,0.25) inset, 0 6px 22px rgba(48,209,88,0.45), 0 2px 6px rgba(0,0,0,0.15)";
      }}
      onMouseLeave={(e) => {
        e.currentTarget.style.background = "linear-gradient(180deg, #3dda6b 0%, #25a244 100%)";
        e.currentTarget.style.transform = "none";
        e.currentTarget.style.boxShadow =
          "0 1px 0 rgba(255,255,255,0.25) inset, 0 4px 16px rgba(48,209,88,0.4), 0 1px 3px rgba(0,0,0,0.15)";
      }}
    >
      <span
        className="absolute top-0 left-0 right-0 h-1/2 rounded-[13px_13px_0_0] pointer-events-none"
        style={{
      ...
      {loading ? (
        ...
        <>
          {label}{" "}
          <span className="inline-block" style={{ transition: "transform 0.2s" }}>
            →
          </span>
        </>
      )}
